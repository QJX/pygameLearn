...
class GameEntity(object):
    ...
    def process(self, time_passed):
        ...
        if self.speed > 0. and self.location != self.destination:
            ...
            # print(self.location, travel_distance, heading)
...
def run():
    ...
    ant_image = pygame.image.load("../res/ant.png").convert_alpha()
    leaf_image = pygame.image.load("../res/leaf.png").convert_alpha()
    spider_image = pygame.image.load("../res/spider.png").convert_alpha()
